...
gear =
  ...
  back:
    base:
      0: text: t('backBase0Text'), notes: t('backBase0Notes'), value:0, last:true
    mystery:
      201402: text: t('backMystery201402Text'), notes: t('headMystery201402Notes'), mystery:mystery['201402'], value: 10
...
api.quests =
  ...
  hedgehog:
    ...
    drop:
      items: [
        {type: 'eggs', key: 'Hedgehog', text: t('questHedgehogDropGryphonEgg')}
        {type: 'eggs', key: 'Hedgehog', text: t('questHedgehogDropGryphonEgg')}
      ]
      gp: 30
      exp: 125
